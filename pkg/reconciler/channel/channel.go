...
func (r *Reconciler) getChannelableStatus(ctx context.Context, bc *eventingduckv1alpha1.ChannelableCombinedStatus, cAnnotations map[string]string) *eventingduckv1.ChannelableStatus {
...
func (r *Reconciler) reconcileBackingChannel(ctx context.Context, channelResourceInterface dynamic.ResourceInterface, c *v1.Channel, backingChannelObjRef duckv1.KReference) (*eventingduckv1alpha1.ChannelableCombined, error) {
	...
	if err != nil {
		if apierrs.IsNotFound(err) {
			...
			channelable := &eventingduckv1alpha1.ChannelableCombined{}
	...
	channelable, ok := backingChannel.(*eventingduckv1alpha1.ChannelableCombined)
	if !ok {
